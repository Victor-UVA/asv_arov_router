...
mavproxy.py --master=/dev/ttyACM0 --out=udpbcast:$GATE.255:14552 --daemon & # ASV --out=udpbcast:$GATE.255:14553
mavproxy.py --master=udpin:192.168.2.1:14550 --out=udpbcast:$GATE.255:14550 --daemon & # AROV --out=udpbcast:$GATE.255:14551
